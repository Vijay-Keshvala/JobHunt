                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <div class="form-check-inline">
                                        <input {{ ($job->status == 0)?'checked':'' }} class="form-check-input" type="radio" value="0" id="status-block"
                                            name="status">
                                        <label class="form-check-label" for="status">
                                            Block
                                        </label>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="experience" id="experience" class="form-control">
                                    <option value="1" {{ ($job->experience == 1) ? 'selected' : '' }}>1 Years</options>
                                    <option value="2" {{ ($job->experience == 2) ? 'selected' : '' }}>2 Years</options>
                                    <option value="3" {{ ($job->experience == 3) ? 'selected' : '' }}>3 Years</options>
                                    <option value="4" {{ ($job->experience == 4) ? 'selected' : '' }}>4 Years</options>
                                    <option value="5" {{ ($job->experience == 5) ? 'selected' : '' }}>5 Years</options>
                                    <option value="6" {{ ($job->experience == 6) ? 'selected' : '' }}>6 Years</options>
                                    <option value="7" {{ ($job->experience == 7) ? 'selected' : '' }}>7 Years</options>
                                    <option value="8" {{ ($job->experience == 8) ? 'selected' : '' }}>8 Years</options>
                                    <option value="9" {{ ($job->experience == 9) ? 'selected' : '' }}>9 Years</options>
                                    <option value="10" {{ ($job->experience == 10) ? 'selected' : '' }}>10 Years</options>
