                    ...
                    <div class="card border-0 shadow p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="experience" id="experience" class="form-control">
                                ...
                                <option value="4" {{(Request::get('experience') == 3) ? 'selected' : ''}}>3 Years
                                </option>
                                <option value="3" {{(Request::get('experience') == 4) ? 'selected' : ''}}>3 Years
                                </option>
                        ...
                        <a href="{{ route("jobs") }}" class="btn btn-secondary mt-3">Reset Filters</a>
                    </div>
                </form>
            </div>
